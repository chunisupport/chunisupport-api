...
│   └── main.go
└── recalculate-player-stats/ # プレイヤーデータ再計算バッチ
    └── main.go
...
| プレイヤーデータ再計算バッチ | `GOOS=linux GOARCH=amd64 go build -o _chunisupport-recalculate-player-stats-linux-amd64 ./cmd/recalculate-player-stats` | `go run ./cmd/recalculate-player-stats` |
