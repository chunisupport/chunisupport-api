...
import (
	...
	"github.com/Qman110101/chunisupport-api/internal/app/handler/api_v1"
	"github.com/Qman110101/chunisupport-api/internal/app/handler/compat/chunirec"
	"github.com/Qman110101/chunisupport-api/internal/app/middleware"
	...
	infra "github.com/Qman110101/chunisupport-api/internal/infra/repository"
	"github.com/Qman110101/chunisupport-api/internal/infra/transaction"
...
func NewRouter(db *sqlx.DB, staticDB *sqlx.DB, cfg config.Config, masterCache *masterdata.Cache, echoLogWriter io.Writer) *echo.Echo {
	...
	chartStatsUsecase := usecase.NewChartStatsUsecase(songRepo, worldsendChartRepo, chartStatsRepo, masterCache, db)
