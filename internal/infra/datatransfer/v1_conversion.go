...
func newPayloadV1(snapshot *entity.UserDataTransferSnapshot) payloadV1 {
	payload := payloadV1{
		Player: playerV1{
			...
			PossessionName:           cloneStringPointer(entity.NormalizePossessionName(snapshot.Player.PossessionName)),
...
func (payload payloadV1) toSnapshot() (*entity.UserDataTransferSnapshot, error) {
	...
	return &entity.UserDataTransferSnapshot{
		Player: entity.UserDataTransferPlayer{
			...
			PossessionName:           entity.NormalizePossessionName(cloneStringPointer(payload.Player.PossessionName)),
