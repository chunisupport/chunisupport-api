...
func NewSongFromOfficial(official *importer.OfficialSong, genreID int) (*entity.Song, error) {
...
func NewSongFromAdditional(additional *importer.AdditionalSong, genreID int) (*entity.Song, error) {
