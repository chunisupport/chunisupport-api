...
func (m *mockDifficultyRepo) FindAll(ctx context.Context) ([]songbatch.Difficulty, error) {
	return []songbatch.Difficulty{
		{ID: 1, Name: "BASIC"},
		{ID: 2, Name: "ADVANCED"},
		{ID: 3, Name: "EXPERT"},
		{ID: 4, Name: "MASTER"},
...
func (m *mockGenreRepo) FindAll(ctx context.Context) ([]songbatch.Genre, error) {
	return []songbatch.Genre{
