...
func TestNewSongFromOfficial(t *testing.T) {
	t.Run("正常系: 通常楽曲", func(t *testing.T) {
		...
		song, err := consolidation.NewSongFromOfficial(official, 1)
		if err != nil {
	...
	t.Run("正常系: WORLD'S END楽曲（WeKanjiあり）", func(t *testing.T) {
		...
		song, err := consolidation.NewSongFromOfficial(official, 2)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("異常系: OfficialIDが空", func(t *testing.T) {
		...
		_, err := consolidation.NewSongFromOfficial(official, 1)
		if err == nil {
...
func TestNewSongFromAdditional(t *testing.T) {
	t.Run("正常系: BPMとリリース日付き", func(t *testing.T) {
		...
		song, err := consolidation.NewSongFromAdditional(additional, 1)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
...
func TestDetermineIsWorldsEnd(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := consolidation.DetermineIsWorldsEnd(tt.official)
			if got != tt.expected {
