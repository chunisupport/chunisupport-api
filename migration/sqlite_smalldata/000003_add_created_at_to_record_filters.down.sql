...
INSERT INTO record_filters_new (id, user_id, name, filter_value_gzip, is_worldsend, updated_at)
SELECT id, user_id, name, filter_value_gzip, is_worldsend, updated_at
FROM record_filters;
